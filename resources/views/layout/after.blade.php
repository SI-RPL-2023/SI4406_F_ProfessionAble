                                    ...
                                    <div class="container-fluid px-0">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                                            <div class="navbar-nav mx-auto me-5">
                                                ...
                                                @if (Auth::user())
                                                    <img src="https://ui-avatars.com/api/?background=random&color=fff&name={{ Auth::user()->name }}"
                                                        alt="" class="userPic" onclick="toggleMenu()">

                                                    <h5 class="my-2 mx-2">{{ Auth::user()->name }}
                                                        ({{ Auth::user()->level }})
                                                    </h5>
                                                @endif
