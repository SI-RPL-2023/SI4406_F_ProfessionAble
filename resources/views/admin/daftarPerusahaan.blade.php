    ...
    <div class="d-flex">
        <div class="d-flex flex-column flex-shrink-0 p-3"
            ...
            <ul class="nav nav-pills flex-column mb-auto mx-2">
                ...
                <li class="mb-2">
                    <a href="/listPerusahaan" class="nav-link"
        ...
        <div class="container mx-5 mt-5 mb-2">
            ...
            <div class="row">
                <div class="col">
                    <h5 class="mt-3 text-secondary">Perusahaan</h5>
                </div>
            </div>
                                    ...
                                    @foreach ($perusahaan as $key)
                                        <tr>
                                            <td scope="row">
                                                @if ($key->foto === null)
                                                    <img
                                                        src="https://ui-avatars.com/api/?background=random&color=fff&name={{ $key->name }}">
                                                @else
                                                    <img src="/foto/{{ $key->foto }}" alt="logo-telkom-indonesia"
                                            ...
                                            <td>
                                                <div class="container d-grid gap-3 d-md-block text-center">
                                                    ...
                                                    <a href="{{ $key->id }}/delete_perusahaan"><button class="btn button fw-bold" style="width: 90px"
