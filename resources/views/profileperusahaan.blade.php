                        ...
                        <div class="col-10">
                            ...
                            <form action="#" class="my-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="industri" class="form-control text-secondary shadow-oren" value="{{ $profile_perusahaan->industri}}" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label fw-medium text-secondary">Ukuran Perusahaan*</label>
                                    <input type="text" name="ukuran_perusahaan" class="form-control text-secondary shadow-oren" value="{{ $profile_perusahaan->ukuran_perusahaan}}" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label fw-medium text-secondary">Jenis Perusahaan*</label>
                                    <input type="text" name="jenis_perusahaan" class="form-control text-secondary shadow-oren" value="{{ $profile_perusahaan->jenis_perusahaan}}" readonly>
                                </div>
                            </form>
                        </div>
                    </div>
